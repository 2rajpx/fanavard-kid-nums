...
class NumberInput extends Component
{
  render() {
    return (
      <InputGroup
        ...
        success={this.props.money.rial.validate===true}
        error={this.props.money.rial.validate===false}>
  ...
  iconColor() {
    if (this.props.money.rial.validate === true) {
      return '#2b8339';
    } else if (this.props.money.rial.validate === false) {
      return '#ed2f2f';
    } else {
      return '#D9D5DC';
    }    
